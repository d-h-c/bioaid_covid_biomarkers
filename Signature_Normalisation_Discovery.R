...
gene.names <- read.csv("data/discovery/gene_names_ensembl89.csv")
...
merged_meta <- read.csv(file = 'data/discovery/discovery_cohort_phenotypes.csv', check.names = F)
...
# remove these 
remove_id <- read.csv("data/discovery/genes_remove.csv", row.names = 1)[,1]
...
write.csv(file = 'data/discovery/betas_discovery.csv', beta_rest)
